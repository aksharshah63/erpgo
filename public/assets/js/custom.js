...
function commonLoader() {
    ...
    //     $('.editor').each(function(e){
    //         CKEDITOR.replace( this.id,{
    //             removePlugins: ['about','image','specialchar','link','unlink','anchor','table','source'],
    //         });
    //     });
    // }
...
$(document).on('click', 'a[data-ajax-popup="true"], button[data-ajax-popup="true"], div[data-ajax-popup="true"]', function () {
    ...
    $.ajax({
        ...
        error: function (data) {
            ...
            show_toastr('Error', data.errors, 'errors')
        }
    });
...
$(document).on('click', 'a[data-ajax-popup-right="true"], button[data-ajax-popup-right="true"], div[data-ajax-popup-right="true"], span[data-ajax-popup-right="true"]', function () {
    var url = $(this).data('url');
