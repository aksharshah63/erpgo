    ...
    <div class="col-sm-12 col-md-12">
        <div class="form-group">
            <div class="custom-control custom-switch">
                ...
                {{ Form::checkbox('range', null, false, ['class' => 'custom-control-input range','id' => 'range']) }}
                {{ Form::label('range', 'Range', ['class' => 'custom-control-label']) }}
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12 col-md-12 enddate d-none">
        <div class="form-group">
