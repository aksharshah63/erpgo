                        ...
                        <div class="form-group">
                            ...
                            <select name="user_type" id="user_type" class="form-control main-element" required>
                                ...
                                @foreach(\App\UserDetail::$user_type as $k => $v)
                                    <option value="{{$k}}" {{ ($user->user_type == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_status" id="user_status" class="form-control main-element" required>
                                ...
                                @foreach(\App\UserDetail::$user_status as $k => $v)
                                    <option value="{{$k}}" {{ ($user->user_status == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            class="text-danger">*</span>
                            {{ Form::text('date_of_hire', \App\Utility::getDateFormated($user->date_of_hire), ['class' => 'form-control datepicker', 'required' => 'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('department', $departments, $user->userdetail->department, ['class' => 'form-control main-element']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('designation', __('Designation'), ['class' => 'form-control-label']) }}
                            {{ Form::select('designation', $designations, $user->userdetail->designation, ['class' => 'form-control main-element']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('location', (isset($user->userdetail->location) ? $user->userdetail->location : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('reporting_to', __('Reporting To'), ['class' => 'form-control-label']) }}
                            {{ Form::select('reporting_to',$userList, $user->userdetail->reporting_to, ['class' => 'form-control main-element']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="source_of_hire" id="source_of_hire" class="form-control main-element">
                                ...
                                @foreach(\App\UserDetail::$source_of_hire as $k => $v)
                                    <option value="{{$k}}" {{ ($user->userdetail->source_of_hire == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::number('pay_rate', (isset($user->userdetail->pay_rate) ? $user->userdetail->pay_rate : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pay_type" id="pay_type" class="form-control main-element">
                                ...
                                @foreach(\App\UserDetail::$pay_type as $k => $v)
                                    <option value="{{$k}}" {{ ($user->userdetail->pay_type == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('father_name', (isset($user->userdetail->father_name) ? $user->userdetail->father_name : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('mother_name', __('Mother Name'), ['class' => 'form-control-label']) }}
                            {{ Form::text('mother_name', (isset($user->userdetail->mother_name) ? $user->userdetail->mother_name : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::number('mobile', (isset($user->userdetail->mobile) ? $user->userdetail->mobile : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('phone', __('Phone'), ['class' => 'form-control-label']) }}
                            {{ Form::number('phone', (isset($user->userdetail->phone) ? $user->userdetail->phone : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('date_of_birth', \App\Utility::getDateFormated($user->userdetail->date_of_birth), ['class' => 'form-control datepicker']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('nationality', __('Nationality'), ['class' => 'form-control-label']) }}
                            {{ Form::text('nationality', (isset($user->userdetail->nationality) ? $user->userdetail->nationality : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" id="gender" class="form-control main-element">
                                ...
                                @foreach(\App\UserDetail::$gender as $k => $v)
                                    <option value="{{$k}}" {{ ($user->userdetail->gender == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control main-element">
                                ...
                                @foreach(\App\UserDetail::$marital_status as $k => $v)
                                    <option value="{{$k}}" {{ ($user->userdetail->marital_status == $k) ? 'selected' : ''}}>{{__($v)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('hobbies', (isset($user->userdetail->hobbies) ? $user->userdetail->hobbies : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('website', __('Website'), ['class' => 'form-control-label']) }}
                            {{ Form::text('website', (isset($user->userdetail->website) ? $user->userdetail->website : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('address1', (isset($user->userdetail->address1) ? $user->userdetail->address1 : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('address2', __('Address2'), ['class' => 'form-control-label']) }}
                            {{ Form::text('address2', (isset($user->userdetail->address2) ? $user->userdetail->address2 : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('city', (isset($user->userdetail->city) ? $user->userdetail->city : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('country', __('Country'), ['class' => 'form-control-label']) }}
                            {{ Form::text('country', (isset($user->userdetail->country) ? $user->userdetail->country : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('state', (isset($user->userdetail->state) ? $user->userdetail->state : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            {{ Form::label('zip_code', __('Zip Code'), ['class' => 'form-control-label']) }}
                            {{ Form::text('zip_code', (isset($user->userdetail->zip_code) ? $user->userdetail->zip_code : null), ['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('biography', (isset($user->userdetail->biography) ? $user->userdetail->biography : null), ['class' => 'form-control', 'rows' => '4', 'cols' => '50']) }}
                        </div>
                    </div>
                </div>
            </div>
