...
@section('action-button')
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        @endcan
        @can('Create Task')
            <a href="{{ route('projects.tasks.index',$project->id) }}" class="btn btn-sm btn-icon rounded-pill btn btn-primary">
                <span class="btn-inner--icon">{{__('Tasks')}}</span>
            </a>
        @endcan
        @can('View Timesheet')
            <a href="{{ route('timesheet.index',$project->id) }}" class="btn btn-sm btn-icon rounded-pill btn btn-primary">
                <span class="btn-inner--icon">{{__('Timesheet')}}</span>
            </a>
        @endcan
        @can('View Grant Chart')
            <a href="{{ route('projects.gantt',$project->id) }}" class="btn btn-sm btn-icon rounded-pill btn btn-primary">
                <span class="btn-inner--icon">{{__('Gantt Chart')}}</span>
            </a>
        @endcan
        @can('View Expense')
            <a href="{{ route('projects.expenses.index',$project->id) }}" class="btn btn-sm btn-icon rounded-pill btn btn-primary">
                <span class="btn-inner--icon">{{__('Expense')}}</span>
            </a>
        @endcan
        <a href="{{ route('projects.index') }}" class="btn btn-sm rounded-circle btn-icon-only btn btn-primary">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-stats">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span class="text-sm text-muted">{{ __('Total Budget').' : '.\Auth::user()->priceFormat($project_data['expense']['total']) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="actions">
                                <a href="#" class="btn btn-sm btn-icon-only rounded-circle ml-4 btn btn-primary" data-url="{{ route('invite.project.member.view', $project->id) }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Member')}}">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @can('Create Milestone')
                            <div class="text-right">
                                <a href="#" data-url="{{ route('project.milestone',$project->id) }}" data-ajax-popup="true" data-title="{{__('Create New Milestone')}}" class="btn btn-sm btn-icon-only rounded-circle ml-4 btn btn-primary">
                                    <span class="btn-inner--icon">
                                        <i class="fas fa-plus"></i>
                                    </span>
                                </a>
