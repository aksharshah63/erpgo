    ...
    <div class="modal-content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="#" class="avatar avatar-sm">
                                        <img {{ $activity->userdetail->img_image }} class="avatar avatar-sm rounded-circle">
                                    </a>
                                </div>
                                <div class="col ml-n2">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="#" class="avatar avatar-sm rounded-circle">
                                        <img {{ $comment->userdetail->img_image }} title="{{ $comment->user->name }}" class="avatar avatar-sm rounded-circle">
                                    </a>
                                </div>
                                <div class="col ml-n2">
        ...
        <div class="modal-footer">
            <div class="col-12 d-flex">
                <div class="pr-3">
                    <img {{ Auth::user()->userdetail->img_image }} title="{{ Auth::user()->name }}" class="avatar rounded-circle avatar-sm">
                </div>
