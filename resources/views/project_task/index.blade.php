...
@section('title')
    {{$project->project_name.__("'s Tasks")}}
@endsection
...
@section('action-button')
    <a href="{{ route('projects.show',$project->id) }}" class="btn btn-sm rounded-circle btn-icon-only ml-2 btn btn-primary">
...
@section('content')
    <div class="card overflow-hidden">
        <div class="container-kanban">
            <div class="kanban-board min-750" data-plugin="dragula" data-containers='{{json_encode($stageClass)}}'>
                        ...
                        <div class="card-list card-list-flush">
                            ...
                            <div class="card-list-body task-list-items" id="task-list-{{ $stage->id }}" data-status="{{$stage->id}}">
                                @foreach($stage->tasks as $taskDetail)
                                    <div class="card card-progress draggable-item border shadow-none" id="{{$taskDetail->id}}" style="{{ !empty($taskDetail->priority_color) ? 'border-left: 2px solid '.$taskDetail->priority_color.' !important' :'' }};">
                                        <div class="card-body">
