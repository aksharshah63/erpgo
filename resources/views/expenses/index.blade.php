...
@section('title')
    {{$project->project_name.__("'s Expenses")}}
@endsection
...
@section('action-button')
    <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        @can('Create Expense')
            <a href="#" class="btn btn-sm btn-icon-only rounded-circle btn btn-primary" data-url="{{ route('projects.expenses.create',$project->id) }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Expense')}}">
