...
@endsection
@section('content')
{{ Form::model($invoice, array('route' => array('invoices.update', $invoice->id), 'method' => 'PUT','class'=>'w-100')) }}
    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            {{ Form::select('customer',$customers, $invoice->customer->id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            class="text-danger">*</span>
                            {{ Form::select('category',$category, $invoice->category_id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            {{ Form::label('reference_no', __('Reference No'), ['class' => 'form-control-label']) }}
                ...
                <div class="table-responsive">
                    <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                {{ Form::select('product_id', $products,null, array('class' => 'form-control select2 item','data-url'=>route('invoice.product'),'required'=>'required')) }}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td> {{ Form::select('discount_type', ['discount-percent' => 'Discount percent','discount-value' => 'Discount value'], $invoice->discount_type, ['class' => 'form-control main-element discount_type']) }}</td>
                            <td class="text-right totalDiscount">{{ Form::text('discount_value',null, ['class' => 'form-control']) }}</td>
                            <td><em style="" class="percentage {{$invoice->discount_type=='discount-value' ? 'd-none' : ''}}">%</em></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
