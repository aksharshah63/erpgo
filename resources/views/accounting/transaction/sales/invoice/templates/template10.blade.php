                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{\App\Utility::dateFormat($settings,$invoice->transaction_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                @if($invoice->getTotalDiscount(true))
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$invoice->getTotalDiscount(true))}}</div>
                                                    </div>
                                                @else
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$invoice->getSubTotal()-$invoice->getTotalDiscount(true)+$taxAmount)}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$invoice->getDue()+$taxAmount)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@if(!isset($preview))
@include('accounting.transaction.sales.invoice.script');
@endif
</body>
</html>
