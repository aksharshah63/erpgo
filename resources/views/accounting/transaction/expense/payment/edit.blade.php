...
<div class="row">
    <div class="col-sm-6 col-md-6">
        <div class="form-group">
            ...
            {{ Form::select('account_id',$accounts, $payment->account_id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
        </div>
    </div>
    <div class="col-sm-6 col-md-6">
        <div class="form-group">
            {{ Form::label('vendor_id', __('Vendor'),['class'=>'form-control-label']) }}<span class="text-danger">*</span>
            {{ Form::select('vendor_id',$vendors, $payment->vendor_id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-sm-6 col-md-6">
        <div class="form-group">
            ...
            {{ Form::select('category_id',$categories, $payment->category_id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
        </div>
    </div>
    <div class="col-sm-6 col-md-6">
        <div class="form-group">
