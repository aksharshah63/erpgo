...
@endsection
@section('content')
{{ Form::model($bill, array('route' => array('bills.update', $bill->id), 'method' => 'PUT','class'=>'w-100')) }}]
    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            {{ Form::label('vendor', __('Vendor'), ['class' => 'form-control-label']) }}<span
                            class="text-danger">*</span>
                            {{ Form::select('vendor',$vendors, $bill->vendor->id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            {{ Form::label('due_date', __('Due Date'), ['class' => 'form-control-label']) }}<span
                            class="text-danger">*</span>
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            class="text-danger">*</span>
                            {{ Form::select('category',$category, $bill->category_id, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            {{ Form::label('order_no', __('Order No'), ['class' => 'form-control-label']) }}
                ...
                <div class="table-responsive">
                    <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                {{ Form::select('product_id', $products,null, array('class' => 'form-control select2 item','data-url'=>route('bill.product'),'required'=>'required')) }}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td> {{ Form::select('discount_type', ['discount-percent' => 'Discount percent','discount-value' => 'Discount value'], $bill->discount_type, ['class' => 'form-control main-element discount_type']) }}</td>
                            <td class="text-right totalDiscount">{{ Form::text('discount_value',null, ['class' => 'form-control']) }}</td>
                            <td><em style="" class="percentage {{$bill->discount_type=='discount-value' ? 'd-none' : ''}}">%</em></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
