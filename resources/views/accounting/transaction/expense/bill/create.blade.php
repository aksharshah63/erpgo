...
@endsection
@section('content')
    {{ Form::open(['url' => 'bills', 'method' => 'post']) }}
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            {{ Form::select('vendor',$vendors, null, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            class="text-danger">*</span>
                            {{ Form::select('category',$category, null, ['class' => 'form-control main-element','id'=>'customer','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
            ...
            <div class="card-body py-0">
                <div class="table-responsive">
                    <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            <td width="25%">
                                {{ Form::select('item', $products,'', array('class' => 'form-control select2 item','data-url'=>route('proposal.product'),'required'=>'required')) }}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td> {{ Form::select('discount_type', ['discount-percent' => 'Discount percent','discount-value' => 'Discount value'], null, ['class' => 'form-control main-element discount_type']) }}</td>
