                    ...
                    <div class="preview-main client-preview">
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{$color}};"></strong>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{\App\Utility::dateFormat($settings,$bill->transaction_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="ship_to">
                                        ...
                                        <p>
                                            ...
                                            @if(!empty($vendor->vendordetail->phone_no)){{$vendor->vendordetail->phone_no}}<br>@endif
                                            @if(!empty($vendor->vendordetail->address1)){{$vendor->vendordetail->address1}}<br>@endif
                                            @if(!empty($vendor->vendordetail->address2)){{$vendor->vendordetail->address2}}<br>@endif
                                            {{!empty( $vendor->vendordetail->post_code)? $vendor->vendordetail->post_code:''}}<br>
                                            {{!empty($vendor->vendordetail->city)?$vendor->vendordetail->city:'' . ', '}} {{!empty($vendor->vendordetail->state)?$vendor->vendordetail->state:'' .', '}},{{!empty($vendor->vendordetail->country)?$vendor->vendordetail->country:''}}
                                        </p>
                                    </div>
                                </div>
                                <div data-v-b8f60a0c="" class="break-25"></div>
                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                @if($bill->getTotalDiscount(true))
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$bill->getTotalDiscount(true))}}</div>
                                                    </div>
                                                @else
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$bill->getSubTotal()-$bill->getTotalDiscount(true)+$taxAmount)}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$bill->getDue()+$taxAmount)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@if(!isset($preview))
@include('accounting.transaction.expense.bill.script');
@endif
</body>
</html>
