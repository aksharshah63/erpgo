...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['url' => 'invoices', 'method' => 'post'])); ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('customer', __('Customer'), ['class' => 'form-control-label'])); ?><span
                            class="text-danger">*</span>
                            <?php echo e(Form::select('customer',$customers, null, ['class' => 'form-control main-element','id'=>'customer','required'=>'required'])); ?>

                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('transaction_date', __('Transaction Date'), ['class' => 'form-control-label'])); ?><span
                            class="text-danger">*</span>
                            <?php echo e(Form::text('transaction_date', null, ['class' => 'form-control datepicker', 'required' => 'required'])); ?>

                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('due_date', __('Due Date'), ['class' => 'form-control-label'])); ?><span
                            class="text-danger">*</span>
                            <?php echo e(Form::text('due_date', null, ['class' => 'form-control datepicker', 'required' => 'required'])); ?>
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('category', __('Category'), ['class' => 'form-control-label'])); ?><span
                            class="text-danger">*</span>
                            <?php echo e(Form::select('category',$category, null, ['class' => 'form-control main-element','id'=>'customer','required'=>'required'])); ?>

                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('reference_no', __('Reference No'), ['class' => 'form-control-label'])); ?>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('billing_address', __('Billing Address'), ['class' => 'form-control-label'])); ?>

                            <?php echo e(Form::textarea('billing_address', null, ['class' => 'form-control', 'rows' => '4', 'cols' => '50'])); ?>
            ...
            <div class="card-body py-0">
                <div class="table-responsive">
                    <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            <td width="25%">
                                <?php echo e(Form::select('item', $products,'', array('class' => 'form-control select2 item','data-url'=>route('proposal.product'),'required'=>'required'))); ?>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="input-group colorpickerinput">
                                        ...
                                        <?php echo e(Form::hidden('itemTaxPrice','0', array('class' => 'form-control itemTaxPrice'))); ?>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td><strong><?php echo e(__('Sub Total')); ?> (<?php echo e(__(\Auth::user()->currencySymbol())); ?>)</strong></td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td> <?php echo e(Form::select('discount_type', ['discount-percent' => 'Discount percent','discount-value' => 'Discount value'], null, ['class' => 'form-control main-element discount_type'])); ?></td>
                            <td class="text-right totalDiscount"><?php echo e(Form::text('discount_value', null, ['class' => 'form-control'])); ?></td>
                            <td><em style="" class="percentage">%</em></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td><strong><?php echo e(__('Tax')); ?> (<?php echo e(__(\Auth::user()->currencySymbol())); ?>)</strong></td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td class="blue-text"><strong><?php echo e(__('Total Amount')); ?> (<?php echo e(__(\Auth::user()->currencySymbol())); ?>)</strong></td>
                ...
                <div class="col-12 text-right py-4">
                    <input class="btn btn-sm btn-primary btn-icon rounded-pill" type="submit" value="<?php echo e(__('Create')); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/accounting/transaction/sales/invoice/create.blade.php ENDPATH**/ ?>