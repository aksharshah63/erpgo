<?php $__env->startSection('title'); ?>
    <?php echo e($project->project_name.__("'s Tasks")); ?>
...
<?php $__env->startSection('action-button'); ?>
    <a href="<?php echo e(route('projects.show',$project->id)); ?>" class="btn btn-sm rounded-circle btn-icon-only ml-2 btn btn-primary">
...
<?php $__env->startSection('content'); ?>
    <div class="card overflow-hidden">
        <div class="container-kanban">
            <div class="kanban-board min-750" data-plugin="dragula" data-containers='<?php echo e(json_encode($stageClass)); ?>'>
                        ...
                        <div class="card-list card-list-flush">
                            ...
                            <div class="card-list-body task-list-items" id="task-list-<?php echo e($stage->id); ?>" data-status="<?php echo e($stage->id); ?>">
                                <?php $__currentLoopData = $stage->tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card card-progress draggable-item border shadow-none" id="<?php echo e($taskDetail->id); ?>" style="<?php echo e(!empty($taskDetail->priority_color) ? 'border-left: 2px solid '.$taskDetail->priority_color.' !important' :''); ?>;">
                                        <div class="card-body">
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var html = "<div class='list-group-item px-0'>" +
                                ...
                                "                                <img " + data.userdetail.img_image + " alt='" + data.user.name + "' class='avatar-sm rounded-circle'>" +
                                "                            </a>" +
                                "                        </div>" +
                                "                        <div class='col ml-n2'>" +
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/project_task/index.blade.php ENDPATH**/ ?>