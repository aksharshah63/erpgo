<?php echo e(Form::model($task, ['route' => ['projects.tasks.update',[$project->id, $task->id]], 'id' => 'edit_task', 'method' => 'PUT'])); ?>
...
<div class="col-12 pt-5 text-right">
    <?php echo e(Form::button(__('Save'), ['type' => 'submit','class' => 'btn btn-sm btn-primary btn-icon rounded-pill'])); ?>

</div>
<?php echo e(Form::close()); ?>

<?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/project_task/edit.blade.php ENDPATH**/ ?>