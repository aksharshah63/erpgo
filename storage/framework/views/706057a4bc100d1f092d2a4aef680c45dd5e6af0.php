                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: <?php echo e($color); ?>; border-top: 15px solid <?php echo e($color); ?>;"><?php echo e(__('INVOICE')); ?></h1></div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: <?php echo e($color); ?>;"></strong>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e(__('Number')); ?>:</td>
                                                <td data-v-b8f60a0c="" class="text-right"><?php echo e(\App\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e(__('Issue Date')); ?>:</td>
                                                <td data-v-b8f60a0c="" class="text-right"><?php echo e(\App\Utility::dateFormat($settings,$invoice->transaction_date)); ?></td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e(__('Due Date')); ?>:</td>
                                                <td data-v-b8f60a0c="" class="text-right"><?php echo e(\App\Utility::dateFormat($settings,$invoice->due_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="ship_to">
                                        ...
                                        <p>
                                            <?php echo e(!empty($customer->first_name)?$customer->first_name:''. ' '); ?> <?php echo e(!empty($customer->last_name)?$customer->last_name:''); ?><br>
                                            <?php if(!empty($customer->customerdetail->phone_no)): ?><?php echo e($customer->customerdetail->phone_no); ?><br><?php endif; ?>
                                            <?php if(!empty($customer->customerdetail->address1)): ?><?php echo e($customer->customerdetail->address1); ?><br><?php endif; ?>
                                            <?php if(!empty($customer->customerdetail->address2)): ?><?php echo e($customer->customerdetail->address2); ?><br><?php endif; ?>
                                            <?php echo e(!empty( $customer->customerdetail->post_code)? $customer->customerdetail->post_code:''); ?><br>
                                            <?php echo e(!empty($customer->customerdetail->city)?$customer->customerdetail->city:'' . ', '); ?> <?php echo e(!empty($customer->customerdetail->state)?$customer->customerdetail->state:'' .', '); ?>,<?php echo e(!empty($customer->customerdetail->country)?$customer->customerdetail->country:''); ?>
                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                <?php if($invoice->getTotalDiscount(true)): ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$invoice->getTotalDiscount(true))); ?></div>
                                                    </div>
                                                <?php else: ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$invoice->getSubTotal()-$invoice->getTotalDiscount(true)+$taxAmount)); ?></div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$invoice->getDue()+$taxAmount)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('accounting.transaction.sales.invoice.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/accounting/transaction/sales/invoice/templates/template10.blade.php ENDPATH**/ ?>