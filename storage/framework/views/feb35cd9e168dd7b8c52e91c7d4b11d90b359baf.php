                    ...
                    <div class="row align-items-center">
                        <div class="col-auto ml-3">
                            <a href="#" class="avatar avatar-sm rounded-circle">
                                <img <?php echo e($user->userdetail->img_image); ?> title=<?php echo e($user->name); ?>/>
                            </a>
                        </div>
                        <div class="col ml-n2">
...
<?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/project_task/create.blade.php ENDPATH**/ ?>