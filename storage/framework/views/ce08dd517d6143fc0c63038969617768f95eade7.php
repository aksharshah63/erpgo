                            ...
                            <div data-v-e95a8a8c="" class="d-inner">
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-2">
                                        <h1 data-v-e95a8a8c="" class="fancy-title tu mb5" style="color: <?php echo e($color); ?>;"><?php echo e(__('PROPOSAL')); ?></h1></div>
                                    <div data-v-e95a8a8c="" class="col-2 text-right">
                                        <img data-v-e95a8a8c="" src="<?php echo e($img); ?>" style="max-width: 250px" class="d-logo"></div>
                                </div>
                                <div data-v-e95a8a8c="" class="break-50"></div>
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c="" class="tu mb5" style="color: <?php echo e($color); ?>;"></strong>
                                        ...
                                        <p data-v-e95a8a8c=""><?php if($settings['company_country']): ?> <?php echo e($settings['company_country']); ?><?php endif; ?></p> <br>
                                    </div>
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right"><?php echo e(\App\Utility::dateFormat($settings,$proposal->transaction_date)); ?></td>
                                            </tr>
                                    ...
                                    <div data-v-e95a8a8c="" class="d-table">
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                <?php if($proposal->getTotalDiscount(true)): ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getTotalDiscount(true))); ?></div>
                                                    </div>
                                                <?php else: ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount(true)+$taxAmount)); ?></div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('accounting.transaction.sales.proposal.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/accounting/transaction/sales/proposal/templates/template3.blade.php ENDPATH**/ ?>