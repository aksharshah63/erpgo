...
<div class="col-xl-8 col-lg-8 col-md-8 d-flex align-items-center justify-content-between justify-content-md-end">
    <div class="row d-flex justify-content-end">
        <div class="col">
            <?php echo e(Form::open(array('route' => array('hr.leave_report'),'method'=>'get','id'=>'leave_report'))); ?>

            <div class="all-select-box">
                <div class="btn-box">
                    <label class="text-xs text-primary"><?php echo e(__('Type')); ?></label> <br>
        ...
        <div class="col month">
            <div class="all-select-box">
                <div class="btn-box">
                    <?php echo e(Form::label('month',__('Month'),['class'=>'text-xs text-primary'])); ?>

                    <?php echo e(Form::month('month',isset($_GET['month'])?$_GET['month']:date('Y-m'),array('class'=>'form-control'))); ?>
        ...
        <div class="col">
            <div class="all-select-box">
                <div class="btn-box">
                    <?php echo e(Form::label('department', __('Department'),['class'=>'text-xs text-primary'])); ?>
        ...
        <div class="col-auto my-auto">
            <a href="#" class="apply-btn" onclick="document.getElementById('leave_report').submit(); return false;" data-toggle="tooltip" data-original-title="<?php echo e(__('Search')); ?>">
                <span class="btn-inner--icon"><i class="fas fa-search"></i></span>
            </a>
            <a href="<?php echo e(route('hr.leave_report')); ?>" class="reset-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset')); ?>">
...
<?php $__env->startSection('content'); ?>
    <div id="printableArea" class="mt-4">
        <div class="row mt-3">
            <div class="col">
                <input type="hidden" value="<?php echo e($filterYear['dateYearRange'].' '.$filterYear['type'].' '.__('Leave Report of').' '. $filterYear['department'].' '.'Department'); ?>" id="filename">
                <div class="card p-4 mb-4">
                    <span class="h6 font-weight mb-0 "><?php echo e(__("Report")); ?> : </span>
                    <h6 class="text-muted mb-1"><?php echo e($filterYear['type'].' '.__('Leave Summary')); ?></h6>
                </div>
            </div>
            <div class="col">
                <div class="card p-4 mb-4">
                    <span class="h6 font-weight mb-0 "><?php echo e(__("Duration")); ?> : </span>
                    <h6 class="text-muted mb-1"><?php echo e($filterYear['dateYearRange']); ?></h6>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <div class="float-left">
                        <span class="h6 font-weight mb-0 "><?php echo e(__('Approved Leaves')); ?></span>
                        <h6 class="text-muted mb-1"><?php echo e($filter['totalApproved']); ?></h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <span class="h6 font-weight mb-0 "><?php echo e(__('Rejected Leaves')); ?></span>
                    <h6 class="text-muted mb-1"><?php echo e($filter['totalReject']); ?></h6>
                </div>
            </div>
            <div class="col-xl-4 col-md-4 col-lg-4">
                <div class="card p-4 mb-4">
                    <span class="h6 font-weight mb-0 "><?php echo e(__('Pending Leaves')); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/erpgo/resources/views/hr/reports/leave_report.blade.php ENDPATH**/ ?>